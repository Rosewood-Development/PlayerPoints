...
public class SettingKey {
    ...
    public static final RoseSetting<List<String>> COMMAND_ALIASES = create("command-aliases", STRING_LIST, List.of("playerp", "p"), "Aliases for the base \"/points\" command", "Requires a restart to take effect");
