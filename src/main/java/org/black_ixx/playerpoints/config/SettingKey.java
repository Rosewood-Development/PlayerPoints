...
public class SettingKey {
    ...
    public static final RoseSetting<Integer> CACHED_ACCOUNT_LIST_UPDATE_FREQUENCY = create("cached-account-list-update-frequency", INTEGER, 300, "How often (in seconds) we update the list of accounts for tab completion purposes.");
