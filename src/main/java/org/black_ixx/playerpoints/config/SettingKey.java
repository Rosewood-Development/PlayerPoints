...
public class SettingKey {
    ...
    public static final RoseSetting<Integer> OFFLINE_PLAYER_LIST_UPDATE_FREQUENCY = create("offline-player-list-update-frequency", INTEGER, 300, "How often (in seconds) we update the list of offline players and non-player accounts for tab completion purposes.");
