...
public class FrenchLocale implements Locale {
    ...
    public Map<String, Object> getDefaultLocaleValues() {
        return new LinkedHashMap<String, Object>() {{
            ...
            this.put("command-giveall-usage", "&cUtilisation: &e/points giveall <montant> [*]");
            ...
            this.put("command-take-usage", "&cUtilisation: &e/points take <joueur> <montant>");
            ...
            this.put("command-look-usage", "&cUtilisation: &e/points look <joueur>");
            ...
            this.put("command-pay-usage", "&cUtilisation: &e/points pay <joueur> <montant>");
            ...
            this.put("command-set-usage", "&cUtilisation: &e/points set <joueur> <montant>");
            ...
            this.put("command-reset-usage", "&cUtilisation: &e/points reset <joueur>");
            ...
            this.put("command-me-usage", "&cUtilisation: &d/points me");
            ...
            this.put("command-lead-usage", "&cUtilisation: &e/points lead [next|prev|#]");
            ...
            this.put("command-broadcast-usage", "&cUtilisation: &e/points broadcast <joueur>");
            ...
            this.put("command-reload-usage", "&cUtilisation: &e/points reload");
            ...
            this.put("command-export-usage", "&cUtilisation: &e/points export");
            ...
            this.put("command-import-usage", "&cUtilisation: &e/points import");
            ...
            this.put("command-convert-usage", "&cUtilisation: &e/points convert <plugin>");
            ...
            this.put("command-importlegacy-description", "&8 - &d/points importlegacy &7- Importe une table hérité");
            this.put("command-importlegacy-usage", "&cUtilisation: &e/points importlegacy <table>");
            this.put("command-importlegacy-success", "&aLes données de la table hérité one été importé avec succès de &b%table%&a.");
            this.put("command-importlegacy-failure", "&cUne erreur est survenue lors de l’importation des données hérité de &b%table%&c. Esc-ce que cette table exist?");
            this.put("command-importlegacy-only-mysql", "&cCette commande est uniquement disponible si vous avez MySQL activé.");

            this.put("#20", "Version Command");
            this.put("command-version-description", "&8 - &d/points version &7- Affiche les informations sur la version PlayerPoints");
        }};
    }
